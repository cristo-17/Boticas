...
@AutoConfigureMockMvc(addFilters = false) // filtros de seguridad reales apagados a propósito: esto prueba DTO/error-shape, no auth (Tarea 12)
class AlertaControllerTest {
    ...
    void listar_devuelvePaginaResponseDelService() throws Exception {
        AlertaResponse alerta = new AlertaResponse("venc-6", "urgente", "Omeprazol 20 mg · lote L-2311D vencido",
                "7 unidades vencieron el 25/08 en B-2. Retíralas y regístralas como merma.", "S/ 80.50",
